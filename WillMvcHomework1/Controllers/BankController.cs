...
namespace WillMvcHomework1.Controllers
{
    public class BankController : Controller
    {
        ...
        {
            ViewBag.客戶Id = new SelectList(db.客戶資料.Where(c => !c.是否刪除), "Id", "客戶名稱");
            return View();
        }
        ...
        public ActionResult Edit(int? id)
        {
            ...
            ViewBag.客戶Id = new SelectList(db.客戶資料.Where(c => !c.是否刪除), "Id", "客戶名稱", 客戶銀行資訊.客戶Id);
            return View(客戶銀行資訊);
        }
